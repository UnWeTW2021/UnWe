...
async function generateSomeriSex() {
  ...
  let callUrl = new URL(
    'http://localhost:3000/UnWe/api/medie_rezidenta/read_one.php'
  );
...
async function generateSomeriIndemnizati() {
  ...
  let callUrl = new URL(
    'http://localhost:3000/UnWe/api/rate_somaj/read_one.php'
  );
  let search_params = callUrl.searchParams;
  search_params.set('judet', judet);
  callUrl.search = search_params.toString();
...
async function generateNivelEducatie() {
  ...
  let callUrl = new URL(
    'http://localhost:3000/UnWe/api/nivelul_educatiei/read_one.php'
  );
  let search_params = callUrl.searchParams;
  search_params.set('judet', judet);
  callUrl.search = search_params.toString();
...
async function generateVarsta() {
  ...
  let callUrl = new URL(
    'http://localhost:3000/UnWe/api/grupa_varsta/read_one.php'
  );
  let search_params = callUrl.searchParams;
  search_params.set('judet', judet);
  callUrl.search = search_params.toString();
