...
<div class="nivelul-educatiei-admin">
    ...
    <input type="number" name="invatamant_universitar" id="invatamant_universitar">
            ...
            <input type="number" name="luna" value="1" min="1" max="12" required id="luna">
            <label for="luna">An</label>
            <input type="number" name="an" value="2021" required id="an">
            <button type="submit"  id="admin-form-submit">Submit</button>
        </form>
    </div>
